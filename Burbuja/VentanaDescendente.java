...
public class VentanaDescendente implements ActionListener{
    ...
    if(e.getSource().equals(g.getB2())){
            Graficadora.plano.paintSQRFunc(Graficadora.plano.getGraphics(),0.05,0,0,0,-200,200);
            Graficadora.plano.paintSQRFunc3(Graficadora.plano.getGraphics(),0.0002,0,0,0,-200,200);
            Graficadora.plano.paintSQRFunc2(Graficadora.plano.getGraphics(),0.002,0,0,0,-200,200);
        }
    if(e.getSource().equals(g.getB3())){
            Graficadora.plano.paintSQRFunc2(Graficadora.plano.getGraphics(),0.0001,0,0.5,0,-200,200);
            Graficadora.plano.paintSQRFunc(Graficadora.plano.getGraphics(),0.0002,0,0.5,0,-200,200);
            Graficadora.plano.paintSQRFunc3(Graficadora.plano.getGraphics(),0.00003,0,0.5,0,-200,200);
        }
